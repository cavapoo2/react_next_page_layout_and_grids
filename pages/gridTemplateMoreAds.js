  ...
  <main className="wrapper">
    <section className="subcategory row">
      <div className="grid-b">
        ...
        <div className="ad">
          <h3><a href="#">Buy more stuff 1!</a></h3>
        </div>
        <div className="ad">
          <h3><a href="#">Buy other stuff 2!</a></h3>
        </div>
        <div className="ad">
          <h3><a href="#">Buy more stuff 3!</a></h3>
        </div>
        <div className="ad">
          <h3><a href="#">Buy other stuff 4!</a></h3>
        </div>
        <div className="ad">
          <h3><a href="#">Buy more stuff 5!</a></h3>
        </div>
        <div className="ad">
          <h3><a href="#">Buy other stuff 6!</a></h3>
        </div>
        <div className="ad">
          <h3><a href="#">Buy other stuff 7!</a></h3>
        </div>
      </div>
    </section>
  </main>    
